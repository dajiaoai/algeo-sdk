...
var shareOptionsSchema = objectType({
  showAiTranscript: booleanType().optional(),
  allowEditing: booleanType().optional()
});
var fileContentV10MetadataSchema = objectType({
...
export { AlgeoError, AlgeoSdk, EMBED_ERROR_CODES, EmbeddedEditor, EmbeddedPresentation, VERSION, convertToLatest, create, createEditor, createPresentation };
